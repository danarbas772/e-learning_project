-- =======================================================
-- SQL INIT ALL DATABASES (MERN E-Learning Platform)
-- Jalankan file ini di MySQL Workbench, phpMyAdmin, atau MySQL CLI
-- =======================================================
...
-- Sample Course
INSERT IGNORE INTO courses (id, title, description, instructor_id, instructor_name, category, level, is_published, is_free)
VALUES (1, 'Pemrograman Web Modern dengan React & Node.js', 'Pelajari pembuatan aplikasi web lengkap dari frontend sampai backend microservice.', 1, 'Admin / Dosen Utama', 'Pemrograman', 'beginner', TRUE, TRUE);
